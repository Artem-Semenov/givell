...
const lottie = bodymovin.loadAnimation({
  ...
  loop: true,
  autoplay: true,
  path: "givell/lottie/1-Hero.json",
});
...
const lottie2 = bodymovin.loadAnimation({
  ...
  loop: true,
  autoplay: true,
  path: "givell/lottie/2-Why_we_exist.json",
});
...
const lottie7 = bodymovin.loadAnimation({
  ...
  loop: true,
  autoplay: true,
  path: "givell/lottie/7-Contact_Stars.json",
});
